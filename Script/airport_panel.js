...
[Script]
生成模块配置 = type=http-response,pattern=^https:\/\/panel\.airport\.rewrite,script-path=https://raw.githubusercontent.com/Sliverkiss/GoodNight/master/Script/airport_panel.js,requires-body=0,max-size=0
