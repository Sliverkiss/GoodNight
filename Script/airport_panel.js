...
async function handleQuery() {
    ...
    // //查询路由
    // switch (true) {
    //     case /^\/data\/github\/repo/.test(query):
    //         $.json = queryGithubRepo();
    //         break;
    //     default:
    //         $.msg($.name, "", query);
    //         break;
